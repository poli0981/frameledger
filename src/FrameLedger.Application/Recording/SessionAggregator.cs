    ...
    private static SessionRow ApplyWitnesses(SessionRow row, Context c)
    {
        ...
        return row with
        {
            ...
            NgxDriverWordsJson = ngx.Outcome == NgxProbeOutcome.NotRun ? null : JsonSerializer.Serialize(new NgxDriverWords
            {
                ...
                Ratio = ngx.Outcome == NgxProbeOutcome.Answered ? (float)ngx.ScalingRatio : null,
                Mode = ngx.Outcome == NgxProbeOutcome.Answered ? ngx.PerformanceMode : null,
                Preset = ngx.Outcome == NgxProbeOutcome.Answered ? ngx.RenderPreset : null,
                FgCount = ngx.Outcome == NgxProbeOutcome.Answered ? ngx.FgCount : null,
                FgPreset = ngx.Outcome == NgxProbeOutcome.Answered ? ngx.FgPreset : null,
                FgMode = ngx.Outcome == NgxProbeOutcome.Answered ? ngx.FgMode : null,
