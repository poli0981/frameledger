...
internal static class SessionRowColumns
{
    ...
    private static void Parameters3(Dictionary<string, object?> d, SessionRow s)
    {
        ...
        d["guard_bypassed"] = s.GuardBypassed ? 1L : 0L;
        d["guard_bypass_family"] = s.GuardBypassFamily;
        d["guard_bypass_signal"] = s.GuardBypassSignal;
    }
    ...
    private static SessionRow Read3(SessionRow row, DbDataReader r) => row with
    {
        ...
        GuardBypassed = L(r, "guard_bypassed") == 1,
        GuardBypassFamily = S(r, "guard_bypass_family"),
        GuardBypassSignal = S(r, "guard_bypass_signal"),
    };
